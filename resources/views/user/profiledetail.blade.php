                    ...
                    <div class="card-body">
                        <div class="card">
                            <div class="card-header">
                                @if($user->photo)
                                    <div class="hide">
                                        <img alt="hello" class="float-right " width="150px" height="150px" style="border:5px solid black;padding:10px;border-radius:50%" src="{{ asset('storage/profile/'.$profile->photo)}}">
                                    </div>
                                @else
                                <div id="select">
